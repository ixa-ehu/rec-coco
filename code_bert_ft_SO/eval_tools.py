...
def correlations( ctr_x, ctr_y, PRED_ctr_x, PRED_ctr_y):
    ...
    '''
    os.remove("pearson_ctr_x.csv")
    os.remove("pearson_pred_x.csv")
    os.remove("pearson_ctr_y.csv")
    os.remove("pearson_pred_y.csv")

    np.savetxt("pearson_ctr_x.csv", ctr_x, delimiter=",")
    np.savetxt("pearson_pred_x.csv", PRED_ctr_x, delimiter=",")
    np.savetxt("pearson_ctr_y.csv", ctr_y, delimiter=",")
    np.savetxt("pearson_pred_y.csv", PRED_ctr_y, delimiter=",")
