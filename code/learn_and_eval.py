...
def main():
    ...
    saveFolder = '../results/results_REF-COCO' #wd.get_folder_name(args)
    ...
    for fold_count, (train_idx, test_idx) in enumerate(kf): # FOLDS loop
        ...
        for method in args.method_compare: # METHODS LOOP
            ...
            if args.save_indiv_predictions == True:
                ...
                wd.write_indiv_predictions(y_pred_train, OBJ_ctr_sd_train, args.model_type, 0.1, indiv_predDir)
                indiv_predDir = saveFolder + '/INDIV_' + method_full + '_fld_test_' + str(fold_count + 1) + '.csv'
